...
public class ClientCameraUtils {
	...
	public static void refreshViewPoint() {
		Minecraft mc = Minecraft.getMinecraft();
		
		switch (WarpDrive.zoomIndex) {
		case 0:
			mc.gameSettings.fovSetting = WarpDrive.normalFOV;
			mc.gameSettings.mouseSensitivity = WarpDrive.normalSensitivity / 2.0F;
			break;
			
		case 1:
			mc.gameSettings.fovSetting = WarpDrive.normalFOV / 1.5F;
			mc.gameSettings.mouseSensitivity = WarpDrive.normalSensitivity / 3.0F;
			break;
			
		case 2:
			mc.gameSettings.fovSetting = WarpDrive.normalFOV / 3.0F;
			mc.gameSettings.mouseSensitivity = WarpDrive.normalSensitivity / 6.0F;
			break;
			
		case 3:
			mc.gameSettings.fovSetting = WarpDrive.normalFOV / 4.5F;
			mc.gameSettings.mouseSensitivity = WarpDrive.normalSensitivity / 9.0F;
			break;
	...
	public static void zoom() {
		...
		WarpDrive.zoomIndex = (WarpDrive.zoomIndex + 1) % 4;
		refreshViewPoint();
